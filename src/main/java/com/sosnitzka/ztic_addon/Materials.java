...
public class Materials {
    ...
    public static Material yrdean = new Material("yrdean", TextFormatting.LIGHT_PURPLE);
    public static Material axiidian = new Material("axiidian", TextFormatting.DARK_GREEN);
    ...
    public static Material aardium = new Material("aardium", TextFormatting.GRAY);
