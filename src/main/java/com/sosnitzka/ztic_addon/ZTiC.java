...
public class ZTiC {
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        registerTinkerMaterial("Rubium", rubium, rubiumFluid, 450, 5.15f, 7.00f, 1.05f, -100, 250, COBALT, false, true);
        registerTinkerMaterial("Prometheum", prometheum, prometheumFluid, 522, 3.6f, 6.60f, 0.90f, 0, 150, TITANITE, false, true);
        registerTinkerMaterial("Arcanite", arcanite, arcaniteFluid, 587, 4.3f, 7.88f, 0.85f, -50, 150, METEORITE, false, true);
        // SOLIDE ORES
        registerTinkerMaterial("Titanite", titanite, titaniteFluid, 779, 4.8f, 4.00f, 1.00f, -50, 150, TITANITE, false, true);
        ...
        registerTinkerMaterial("Adamantite", adamantite, adamantiteFluid, 998, 8.9f, 7.00f, 1.20f, -200, 300, ADAMANTITE, false, true);
        // ETHERE ORES
        registerTinkerMaterial("Eternite", eternite, eterniteFluid, 366, 7.35f, 1.95f, 1.10f, 150, 150, COBALT, false, true);
        registerTinkerMaterial("Mythril", mythril, mythrilFluid, 434, 8.75f, 2.87f, 0.98f, -100, 200, TITANITE, false, true);
        registerTinkerMaterial("Palladium", palladium, palladiumFluid, 598, 10.4f, 3.13f, 1.09f, 0, 100, METEORITE, false, true);
        ...
        registerTinkerMaterial("Violium", violium, violiumFluid, 445, 4.2f, 3.30f, 1.00f, 133, 150, COBALT, false, true);
        registerTinkerMaterial("Mindorite", mindorite, mindoriteFluid, 463, 6.41f, 4.40f, 0.90f, 83, 100, TITANITE, false, true);
        registerTinkerMaterial("Karmesine", karmesine, karmesineFluid, 602, 6.75f, 5.10f, 0.99f, 0, 200, METEORITE, false, true);
        ...
        registerTinkerMaterial("Bysmuid", bysmuid, bysmuidFluid, 364, 5.22f, 6.47f, 1.09f, -80, 197, COBALT, false, true);
        registerTinkerMaterial("Ultranite", ultranite, ultraniteFluid, 1012, 5.72f, 6.76f, 1.02f, -120, 210, VIBRANIUM, false, true);
        registerTinkerMaterial("Astrium", astrium, astriumFluid, 593, 5.28f, 9.14f, 0.91f, -45, 170, VIBRANIUM, false, true);
        registerTinkerMaterial("Imperomite", imperomite, imperomiteFluid, 764, 11.60f, 3.57f, 1.05f, -38, 125, METEORITE, false, true);
        ...
        registerTinkerMaterial("Fractoryte", fractoryte, fractoryteFluid, 1115, 7.65f, 7.75f, 1.15f, -250, 283, METEORITE, false, true);
        registerTinkerMaterial("Aegisalt", aegisalt, aegisaltFluid, 415, 8.88f, 3.18f, 1.00f, 175, 125, TITANITE, false, true);
        registerTinkerMaterial("Nocturnyx", noctunyx, noctunyxFluid, 624, 10.43f, 3.25f, 0.99f, -125, 183, METEORITE, false, true);
        registerTinkerMaterial("Nucleum", nucleum, nucleumFluid, 522, 11.30f, 3.22f, 1.05f, 100, 125, TITANITE, false, true);
        registerTinkerMaterial("Seismodium", seismodium, seismodiumFluid, 879, 13.85f, 4.19f, 1.17f, -75, 169, VIBRANIUM, false, true);
        registerTinkerMaterial("Lumixyl", lumixyl, lumixylFluid, 350, 4.64f, 5.92f, 1.05f, 15, 130, COBALT, false, true);
